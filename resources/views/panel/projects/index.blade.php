                ...
                <div class="modal fade" id="add_new" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('panel_project_store')}}" enctype="multipart/form-data" method="post">
                                @csrf
                        ...
                        @foreach($projects as $project)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('panel_project_show',['project'=>$project->id])}}"  title="مشاهده جزئیات" class="btn btn-icon btn-light-success btn-sm"><i class="fas fa-eye"></i></a>
                                    ...
                                    <div class="modal fade" id="edit_{{$project->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('panel_project_update',['project'=>$project->id])}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="form-group text-left">
                                                            <label>نام پروژه</label>
    ...
    <script>
        function delbrand(id) {
            Swal.fire({
                ...
                if (result.value) {
                    window.open('/panel/settings/brands/delete/'+id,'_self');
                }
            })
